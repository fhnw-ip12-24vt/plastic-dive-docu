...
| Step | Action          | Expected Result                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
|------|-----------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1    | Launch the game | There should be a blue background with the [backLayer.png](https://github.com/fhnw-ip12-24vt/plastic-dive-app/main/src/main/resources/assets/frontLayer.png?ref_type=heads), [middleLayer.png](https://github.com/fhnw-ip12-24vt/plastic-dive-app/main/src/main/resources/assets/middleLayer.png?ref_type=heads) and [frontLayer.png](https://github.com/fhnw-ip12-24vt/plastic-dive-app/main/src/main/resources/assets/frontLayer.png?ref_type=heads) there should also be a floating [barcode scanner](https://github.com/fhnw-ip12-24vt/plastic-dive-app/main/src/main/resources/assets/barcodeScanner.png?ref_type=heads) with a text prompting a player to scan a barcode on a clothing piece. |
...
| Step | Action                              | Expected Result                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
|------|-------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1    | Scan a bar code on a clothing piece | the floating barcode should disappear and instead there should be an [animation with a washing machine](https://github.com/fhnw-ip12-24vt/plastic-dive-app/main/src/main/resources/assets/washingMachineEasy.png?ref_type=heads) based on what clothing you scanned. Near the and the background should move with a parallax towards the left and the 2 [player animations](https://github.com/fhnw-ip12-24vt/plastic-dive-app/main/src/main/resources/assets/player.png?ref_type=heads) should swim into the screen. |
